...
import { Plus, Pencil, Trash2, LayoutDashboard, Package, ShoppingBag, LogOut, X, Image, Upload } from 'lucide-react'
      ...
      <div className="admin-layout">
        <aside className="admin-sidebar">
          <div style={{ padding: '8px 14px 20px', borderBottom: '1px solid var(--border)', marginBottom: 8 }}>
            <span style={{ fontSize: '1rem', fontWeight: 800, background: 'linear-gradient(135deg,#7c3aed,#a855f7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>⚡ Boostify Admin</span>
          </div>
          {navItems.map(item => (
