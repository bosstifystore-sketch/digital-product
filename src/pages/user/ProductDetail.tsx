...
export default function ProductDetail() {
  ...
  const images = (product.images?.filter(img => img && img.trim() !== '').length)
    ...
    : ['https://placehold.co/600x450/13131f/7c3aed?text=Boostify']
      ...
      <div className="product-detail-grid">
        ...
        <div className="product-images">
          <img
            ...
            onError={(e) => { (e.target as HTMLImageElement).src = 'https://placehold.co/600x450/13131f/7c3aed?text=Boostify' }}
          />
          {images.length > 1 && (
